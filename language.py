...
LANGUAGES = {
    "zh": {
        ...
        "reset_success_title": "恢复成功",
        "reset_success_message": "所有设置已恢复为默认值",
        "radius_label": "圆角半径:",
        "color_label": "圆角颜色:",
        "anti_burn_in": "启用防烧屏",
    ...
    "en": {
        ...
        "reset_success_message": "All settings have been restored to default values",        
    ...
    "fr": {
        ...
        "reset_success_message": "Tous les paramètres ont été rétablis aux valeurs par défaut",    
    ...
    "ja": {
        ...
        "help": "ヘルプ",
        "exit": "終了",
        "reset_defaults": "デフォルト設定に戻す",
        "reset_success_title": "復元成功",
        "reset_success_message": "すべての設定がデフォルト値に復元されました",
        "radius_label": "コーナー半径:",
        "color_label": "コーナーカラー:",
    ...
    "ko": {
        ...
        "reset_success_title": "복원 성공",
        "reset_success_message": "모든 설정이 기본값으로 복원되었습니다",
        "radius_label": "모서리 반경:",
        "color_label": "모서리 색상:",
